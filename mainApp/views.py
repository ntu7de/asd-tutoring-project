...
def accountSettings2t(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            or form.data['monday_start'] == form.data['monday_end'] \
            or form.data['tuesday_start'] == form.data['tuesday_end'] \
            or form.data['wednesday_start'] == form.data['wednesday_end'] \
            or form.data['thursday_start'] == form.data['thursday_end'] \
            or form.data['friday_start'] == form.data['friday_end']:
